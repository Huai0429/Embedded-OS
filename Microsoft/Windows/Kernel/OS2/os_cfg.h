...
#define OS_TICKS_PER_SEC         100u   /* Set the number of ticks in one second                        *///set the second
...
#define OS_TASK_STAT_EN           0u   /*     Task[62] Enable (1) or Disable(0) the statistics task             */
